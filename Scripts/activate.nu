...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Desktop\python\lecturer_Eyal\Project1\back\myenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\Desktop\python\lecturer_Eyal\Project1\back\myenv\Scripts\deactivate.nu'
